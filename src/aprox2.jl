...
inputs_gray, targets = crear_inputs_targets_binarias(no_melanoma_gray, melanoma_gray, index)
...
dataset = extraer_caracteristicas_aprox2(inputs_bmp, inputs_gray, axis)
...
#scatter(datos_clase_0[:, 1], datos_clase_0[:, 2], xlabel = "Longitud del Borde", ylabel = "Asimetría", color=:green, label="No melanoma")
#scatter!(datos_clase_1[:, 1], datos_clase_1[:, 2], xlabel = "Longitud del Borde", ylabel = "Asimetría", color=:red, label="Melanoma")

#=
scatter3d( datos_clase_0[:, 1], datos_clase_0[:, 2],datos_clase_0[:, 3], 
    xlabel="Longitud del Borde", ylabel="Asimetría", zlabel="Claridad",
    color=:green, label="No Melanoma")

scatter3d!(datos_clase_1[:, 1], datos_clase_1[:, 2],datos_clase_1[:, 3] , 
xlabel="Longitud del Borde", ylabel="Asimetría", zlabel="Claridad",
