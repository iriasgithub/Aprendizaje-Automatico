...
println(size(datos_atypical_nevus))


scatter(datos_no_melanoma[:, 1], datos_no_melanoma[:, 2], xlabel = "Regularidad", ylabel = "Asimetría", color=:green, label="No melanoma")
scatter!(datos_melanoma[:, 1], datos_melanoma[:, 2], xlabel = "Regularidad", ylabel = "Asimetría", color=:red, label="Melanoma")
scatter!(datos_atypical_nevus[:, 1], datos_atypical_nevus[:, 2], xlabel = "Regularidad", ylabel = "Asimetría", color=:blue, label="Atypical Nevus")
=#
